...
class BaseHandler:
    ...
    async def handle(self, tg_id: int, message_id: int = None, state: bool | str = None, filters: list[str] = None,
                     edit_callback: str | list[str] = None, edit_text: str | list[str] = None,
